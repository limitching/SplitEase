...
const Group = () => {
  const { group, isLoading, isPublicVisit, wrapperOutletRef, setShowFixedButton, slug } = useContext(GroupContext);
      ...
      {Object.keys(group).length !== 0 ? (
        isPublicVisit ? (
          ...
          <WrapperGroupContainer>
            ...
            <Tabs></Tabs>
            <WrapperOutlet ref={wrapperOutletRef} onScroll={handleScroll}>
              <Outlet></Outlet>
              <Footer></Footer>
            </WrapperOutlet>
            <Fab
