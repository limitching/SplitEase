                ...
                <div key={"settlingDebtsList" + index}>
                  ...
                  <ListItem>
                    ...
                    >
                        ...
                        <Tooltip title={debtor.name}>
                          <Avatar
                            ...
                            src={
                              debtor.image
                                ? debtor.image
                                : ANIMAL_AVATAR[indexMap.get(debtor.id)]
                            }
                            sx={{
                              width: 50,
                              height: 50,
                        ...
                        <Tooltip title={creditor.name}>
                          <Avatar
                            ...
                            src={
                              creditor.image
                                ? creditor.image
                                : ANIMAL_AVATAR[indexMap.get(creditor.id)]
                            }
                            sx={{
                              width: 50,
                              height: 50,
                      ...
                      >
                        <Tooltip title={`Marked as settled`}>
                          <IconButton
                            onClick={(event) => {
                              setSelectDebt({
                                payer_id: debtor.id,
