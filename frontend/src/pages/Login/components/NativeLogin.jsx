...
const NativeLogin = () => {
  ...
  const { setHaveAccount, setLoginMethod, nativeSignIn } = useContext(AuthContext);
  ...
  return (
    <>
      ...
      >
        ...
        <HaveAccountAlready onClick={() => setHaveAccount(false)}>Don't have an account yet?</HaveAccountAlready>
        <OtherLoginMethod onClick={() => setLoginMethod(null)}>Other login methods</OtherLoginMethod>
      </LoginFormContainer>
    </>
  );
};
