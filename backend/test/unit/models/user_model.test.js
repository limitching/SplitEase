...
describe("signUp function", () => {
  ...
  test("should throw an error when pool.getConnection() throws an error", async () => {
...
describe("nativeSignIn function", () => {
  ...
  test("should return an error if the account does not exist", async () => {
  ...
  test("should update last login time and return the user object", async () => {
    const result = await User.nativeSignIn(email, password);
...
describe("getLineProfile function", () => {
  ...
  test("should throw an error when axios.post throws an error", async () => {
    const code = "testCode";
    const state = "testState";
...
describe("getUserGroupsIds function", () => {
  ...
  test("should return group ids for a user", async () => {
...
describe("getGroupsInformation function", () => {
  ...
  test("should return groups information for groupsIds", async () => {
...
describe("updateProfile function", () => {
  ...
  test("should update user profile and return modified profile data", async () => {
    const user_id = 1;
  ...
  test("should catch error and return error object", async () => {
    const user_id = 2;
    const modifiedUserProfile = {
      name: "Test",
      email: "test@example.com",
...
describe("bindingLineUser function", () => {
  ...
  test("should update user's line_id and return user name", async () => {
...
describe("getBindingUser", () => {
  ...
  test("should return 0 if user does not exist", async () => {
  ...
  test("should return error if database query throws error", async () => {
    const mockSource = { userId: "123456" };
